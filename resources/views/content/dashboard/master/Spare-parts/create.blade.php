                    ...
                    <div class="row">
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">
                                Spare Part Create
                                <span class="float-end"><a href="{{ route('spare-parts') }}" class="btn btn-md btn-success">Back</a></span>
                            </span>

                            <form action="{{ route('spare-parts-save') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control mt-n3" name="name" value="{{ old('name') }}">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control mt-n3" name="serial_no" value="{{ old('serial_no') }}">
                                    ...
                                    <div class="col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <input type="file" class="form-control mt-n3" name="image" accept="image/*">
                                          @if ($errors->has('image'))
                                              <span class="invalid-feedback" style="display: block;" role="alert">
