                    ...
                    <div class="row">
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">
                                ...
                                <span class="float-end"><a href="{{ route('spare-parts-create') }}" class="btn btn-md btn-info">Add</a></span>
                            </span>
                                    ...
                                    <tbody>
                                        @foreach ($data as $part)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($part->image)
                                                        <img src="{{ asset($part->image) }}" alt="Spare Part Image" style="width: 50px; height: 50px;">
                                                    @else
                                                        No Image
                                                    @endif
                                                </td>
                                                <td>
                                                    ...
                                                    @endif
                                                    <a class="box-edit" href="{{ route('spare-parts-edit', $part->id) }}">
