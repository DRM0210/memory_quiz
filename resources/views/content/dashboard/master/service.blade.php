                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">Service
                                Information <span class="float-end"><a href="{{ route('service-create') }}"
...
<<<<<<< HEAD
                                                        <a class="btn btn-md btn-info"
                                                            href="{{ route('service-edit', $user->id) }}"><i
                                                                class="bx bx-edit-alt me-2"></i> Edit</a>
                                                        <a class="btn btn-md btn-danger deleteClient" data-id="{{ $user->id }}"
