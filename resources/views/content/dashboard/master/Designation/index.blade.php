                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">Designation
                                Information <span class="float-end"><a href="{{ route('designation-create') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-md btn-info"
                                                            href="{{ route('designation-edit', $user->id) }}"><i
