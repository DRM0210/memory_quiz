<div class="card p-2">
    <div class="row">
        ...
        <div class="col-md-3">
            {{-- <form action="#" method="GET">
                <div class="input-group input-group-merge">
                    <input type="text" class="form-control" name="machine" placeholder="Search..." aria-label="Search..."
                        aria-describedby="basic-addon-search31">
                    <button class="input-group-text" type="submit" id="searchButton">
        ...
        <div class="col-md-9 text-end">
            <a href="{{ route('client.job.create', $client->id) }}" class="btn btn-md btn-info">Add
                Job</a>
        </div>
    </div>
                ...
                @if (count($clientjobs) != 0)
                    @foreach ($clientjobs as $clientjob)
                        <tr>
                            ...
                            <td>
                                <a class="box-view mx-1" title="View"  href="{{ route('job-view', $clientjob->id) }}">
