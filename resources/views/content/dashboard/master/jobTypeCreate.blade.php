                    ...
                    <div class="row">
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">
                              Job Type Create
                                <span class="float-end"><a href="{{ route('job-type') }}" class="btn btn-md btn-success">Back</a></span>
                            </span>

                            <form action="{{ route('job-type-save') }}" method="post" enctype="multipart/form-data">
                                @csrf
