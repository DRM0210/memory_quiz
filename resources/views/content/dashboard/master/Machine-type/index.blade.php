                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">Machine Type
                                Information <span class="float-end"><a href="{{ route('machine-type-create') }}"
                                            ...
                                            @foreach ($data as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif
                                                        <a class="box-edit"
                                                            href="{{ route('machine-type-edit', $user->id) }}"><i
                                                                class="bx bx-edit-alt"></i></a>
                                                        <a class="box-delete deleteClient" data-id="{{ $user->id }}"
