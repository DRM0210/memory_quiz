                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">Client Category
                                Create <span class="float-end"><a href="{{ route('client-sub-category') }}"
                                        class="btn btn-md btn-success">Back</a></span></span>

                            <form action="{{ route('client-sub-category-save') }}" method="post">
                                @csrf
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="input1" class="col-sm-2">
                                                <span class="h6 small bg-white text-dark pl-2 pr-2">Category <span class="text-danger">*</span>
                                                </span></label>
                                            <select type="text" class="form-control mt-n3" name="category_id">
