                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">Client Sub Category
                                Edit <span class="float-end"><a href="{{ route('client-sub-category') }}"
                                        class="btn btn-md btn-success">Back</a></span></span>

                            <form action="{{ route('client-sub-category-update', $data['id']) }}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="category_id" class="col-sm-2">
                                                <span class="h6 small bg-white text-dark pl-2 pr-2">
                                                    Category <span class="text-danger">*</span>
                                                </span>
                                            </label>

                                            <select class="form-control mt-n3" name="category_id" id="category_id" required>
