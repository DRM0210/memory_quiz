                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">Client Category
                                 <span class="float-end"><a href="{{ route('client-category-create') }}"
                                    ...
                                    <tbody class="table-border-bottom-0">
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          @endif
                                            <a class="btn btn-md btn-info"  href="{{ route('client-category-edit',$user->id) }}"><i class="bx bx-edit-alt me-2"></i> Edit</a>
  ...
  $(document).ready(function(){
      $(".changeState").click(function(){
        ...
        if (confirm("Do you want to change status !")) {
          $.ajax({
            type:'POST',
            url:"{{ route('client-category-status') }}",
      ...
      $(".deleteClient").click(function(){
        ...
        if (confirm("Do you want to delete this item !")) {
          $.ajax({
            type:'POST',
            url:"{{ route('client-category-delete') }}",
