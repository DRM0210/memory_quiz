                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 border p-2">
                            <span class="w-100 d-block p-1 fw-bold text-dark" style="background: #e5e5e5;">Task
                                Create <span class="float-end"><a href="{{ route('task') }}"
                            ...
                            <form action="{{ route('task-save') }}" method="post">
                                ...
                                <div class="col-md-12 addMoreBox mt-2">
                                  <h6 class="">Subtask Items</h6>
                                  <div id="subtask-items">
                                      <div class="row subtask-item">
                                          <div class="col-md-5">
                                              <div class="form-group">
                                                <label for="input1" class="col-sm-2"><span class="h6 small bg-white text-dark pl-2 pr-2">Name</span></label>
                                                  <input class="form-control subtask-name mt-n3" type="text" name="subtask_name[]"
                                                      >
                                              </div>
                                          </div>
                                          <div class="col-md-5">
                                              <div class="form-group">
                                                <label for="input1" class="col-sm-2">
                                                  <span class="h6 small bg-white text-dark pl-2 pr-2">Summary
                                                  </span></label>
                                                  <input class="form-control subtask-slug mt-n3" type="text" name="subtask_desc[]" >
                                              </div>
                                          </div>
                                          <div class="col-md-2 d-flex align-items-end">
                                              <button type="button" class="btn btn-info mb-2" onclick="addRow()">Add</button>
                                          </div>
                                      </div>
                                  </div>
                                </div>
                              ...
                              <script>
                                  function addRow() {
                                      ...
                                      `;
                                      document.getElementById('subtask-items').insertAdjacentHTML('beforeend', newRow);
                                  }
