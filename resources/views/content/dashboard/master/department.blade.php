...
<div class="card">
  <h4 class="card-header">Department<span class="float-end"><a href="{{ route('department-create',Request()->id) }}" class="btn btn-md btn-info mx-2">Add</a><a href="{{ route('client-view',Request()->id) }}" class="btn btn-success">Go Back</a></span></h4>
  @if(session('success'))
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          ...
          <td>
            ...
            @endif
            <a class="btn btn-md btn-info" href="{{ route('department-edit', ['id' => request()->id, 'id1' => $user->id]) }}">
