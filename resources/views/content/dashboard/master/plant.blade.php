...
<div class="card">
  <h4 class="card-header">Plant<span class="float-end"><a href="{{ route('plant-create',Request()->id) }}" class="btn btn-info mx-2">Add</a><a href="{{ route('client-view',Request()->id) }}" class="btn btn-success">Go Back</a></span></h4>
  @if(session('success'))
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          ...
          <td>
            ...
            @endif
              <a class="btn btn-md btn-info" href="{{ route('plant-edit', ['id' => request()->id, 'id1' => $user->id]) }}">
  ...
  $(document).ready(function(){
      ...
      $(".deleteClient").click(function(){
        ...
        if (confirm("Do you want to delete this item !")) {
          $.ajax({
            type:'POST',
            url:"{{ route('plant-delete',request()->id) }}",
