...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      <h5 class="card-header">Profile Details<span class="float-end"><a href="{{route('profile.password')}}" class="btn btn-info" >Change Password</a></span></h5>
      @if(session('success'))
      ...
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          @if($data->image != null)
          <img src="{{ URL::to('/') }}/{{$data->image}}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
          @else
      ...
      <div class="card-body">
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="text" id="email" name="email" value="{{$data->email}}" placeholder="john.doe@example.com" />
            </div>
            {{-- <div class="mb-3 col-md-6">
