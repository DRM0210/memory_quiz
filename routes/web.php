...
use App\Http\Controllers\authentications\{LoginController, SettingController};
...
Route::group(['middleware' => 'auth'], function () {
  ...
  Route::get('/profile-password', [UserController::class, 'profilePassword'])->name('profile.password');
  Route::post('/password-update', [UserController::class, 'profilePasswordUpdate'])->name('password-update');

  Route::get('/admin-setting', [SettingController::class, 'adminSetting'])->name('admin-setting');
  Route::post('/admin-setting-update', [SettingController::class, 'adminSettingUpdate'])->name('admin.setting.update');

  Route::controller(QuizTypeController::class)
...
Route::post('/layouts/blank', [Blank::class, 'index'])->name('layouts-blank');
